  ...
  return (
    <Main title={"Rentals Management"}>
      ...
      <div className="p-3 d-flex flex-wrap justify-content-center">
        {vehicles.map((v, i) => (
          <Link
            to={"/Secretary/Secretary/Rentals-management/Contract"}
            key={i}
            className="contract-card w-100 p-3 m-1 d-flex flex-sm-row flex-column"
          >
            <div className="img-containe rent-vehicle w-25 d-flex m-auto justify-content-center align-items-center ">
              <img
            ...
            <ul className="list-unstyled w-100 my-1 rent-info flex-column ">
              <li className="d-flex flex-wrap">
                <p className="my-1 mx-2">
                  <b>ID location:</b> <span>1234567890</span>
                </p>
              </li>
              <li className="d-flex flex-wrap">
                <p className="m-0">
              ...
              <li className="d-flex flex-wrap">
                <p className="my-1 mx-2">
                  <b>Renter:</b> <span className="p-1">BENABDESSADOK Safa</span>
                </p>
                <p className="my-1 mx-2">
                  <b>Renter ID:</b> <span className="p-1">1234567890</span>
                </p>
              </li>
              <li className="d-flex flex-wrap">
                <p className="my-1 mx-2">
